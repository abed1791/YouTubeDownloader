# ==============================================================
# YouTube Downloader - Educational Edition (Final Version)
# ==============================================================
# الميزات المضافة:
# ✔ حفظ الاسم الأصلي للفيديو
# ✔ دعم Playlist
# ✔ اختيار جودة الفيديو أو تحديد حجم مخصص
# ✔ اختيار أفضل جودة ضمن الحجم المحدد
# ✔ ضغط الفيديو فقط عند الحاجة (إذا تجاوز الحجم المحدد)
# ✔ دمج الفيديو مع الصوت دائمًا
# ✔ MP3 بجودة 16kbps
# ✔ زر إلغاء التحميل في أي وقت
# ✔ شريط تقدم صحيح لجميع الفيديوهات
# ✔ فتح مجلد التحميل بعد انتهاء التحميل
# ✔ زر مستقل لفتح مجلد التحميل
# ✔ مربع يعرض المسار الحالي لمجلد التحميل
# ✔ لصق بزر الفأرة في مربع الرابط
# ✔ يعمل بدون أخطاء ANSI مع PyInstaller
...
class YouTubeDownloader(ctk.CTk):
    ...
    # ==========================================================
    # تهيئة البرنامج والمتغيرات الأساسية
    # ==========================================================
    def __init__(self):
        super().__init__()
    ...
    def build_ui(self):
        ...
        # مربع إدخال الرابط مع دعم اللصق بزر الفأرة
        ...
        # عرض مجلد الحفظ الحالي
        self.path_label = ctk.CTkEntry(self)
        self.path_label.pack(pady=5, padx=20, fill="x")
    ...
    def download_video(self):
        ...
        ydl_opts = {
            "format": selected[1] if selected else "bestvideo+bestaudio/best",
        ...
        try:
            ...
            if max_size:
                file_path = max([os.path.join(self.save_path, f) for f in os.listdir(self.save_path)], key=os.path.getctime)
