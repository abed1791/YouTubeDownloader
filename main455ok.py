# ============================================================
#  Advanced Educational Downloader & Compressor (Stable Build)
# ============================================================
#
# ======================= الميزات ============================
#
...
# ✔ دعم Playlist
# ✔ اختيار جودة مع إظهار الحجم لكل دقة
...
# ✔ بدون أخطاء ANSI / Unicode
#
# قسم الضغط المحلي:
# ✔ تحليل الفيديو
# ✔ ضغط مع الصوت
# ✔ Smart CRF
# ✔ حساب bitrate عند تحديد حجم
# ✔ شريط تقدم حقيقي
#
# ============================================================
...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.title("عبد الباسطEducational Downloader & Compressor V455ok")
    ...
    def download_video(self):
        ...
        ydl_opts = {
            ...
            "outtmpl": unique_filename(os.path.join(self.save_path, "%(title)s.%(ext)s")),
        ...
        try:
            ...
            self.log("Download cancelled or failed.")
    ...
    def compress_video(self):
        ...
        for line in process.stderr:
            if "time=" in line:
                self.progress.set(min(self.progress.get()+0.01,1))
...
# ============================================================
# تشغيل آمن (لا تختفي الواجهة عند الخطأ)
# ============================================================
